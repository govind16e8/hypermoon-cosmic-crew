...
const AboutSection: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-b from-cosmic-dark to-black relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="md:w-1/2">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-white font-orbitron">
            ...
            <div className="space-y-4 mt-8">
              <div className="flex items-start">
                <Star className="h-5 w-5 md:h-6 md:w-6 text-cosmic-purple mr-3 mt-1 flex-shrink-0" />
              ...
              <div className="flex items-start">
                <Users className="h-5 w-5 md:h-6 md:w-6 text-cosmic-purple mr-3 mt-1 flex-shrink-0" />
                <p className="text-base md:text-lg text-gray-300">
              ...
              <div className="flex items-start">
                <Zap className="h-5 w-5 md:h-6 md:w-6 text-cosmic-purple mr-3 mt-1 flex-shrink-0" />
                <p className="text-base md:text-lg text-gray-300">
