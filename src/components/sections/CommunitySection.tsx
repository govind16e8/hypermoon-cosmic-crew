...
import { Star, Twitter, Mail, Users } from 'lucide-react';
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-cosmic-dark to-black relative">
      <div className="container mx-auto px-4 text-center">
        ...
        {/* Community counter */}
        <div className="mb-10 inline-flex items-center justify-center py-3 px-6 bg-cosmic-deep-purple/30 border border-cosmic-purple rounded-full">
          <Users className="h-6 w-6 text-cosmic-purple mr-3" />
          <span className="text-xl font-medium text-white">
            <span className="text-cosmic-purple font-bold">500+</span> members already joined!
          </span>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-10">
          <a 
            href="#" 
            className="flex items-center justify-center p-4 bg-white/5 hover:bg-white/10 border border-cosmic-purple rounded-lg transition-all duration-300 group hover:scale-105"
          >
